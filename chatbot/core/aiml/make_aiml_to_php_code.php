...
function aiml_to_phpfunctions($convoArr)
{
	...
	runDebug( __FILE__, __FUNCTION__, __LINE__, "Converting the AIML to PHP code",3);
	...
	if(($convoArr['aiml']['aiml_to_php']!="")&&($uac==0)){
		...
		runDebug( __FILE__, __FUNCTION__, __LINE__, "Generating new AIML to PHP code - $msg",1);
		...
		//start the find and replace
			...
			runDebug( __FILE__, __FUNCTION__, __LINE__, "Made initial bot property replacements",3);
			...
			runDebug( __FILE__, __FUNCTION__, __LINE__, "Built core tag array to make replacements",3);
			...
			runDebug( __FILE__, __FUNCTION__, __LINE__, "Built custom tag array to make replacements",3);
			runDebug( __FILE__, __FUNCTION__, __LINE__, "Looking to replace: ".print_r($find,true),3);
			runDebug( __FILE__, __FUNCTION__, __LINE__, "With replacements: ".print_r($replace,true),3);
	...
	runDebug( __FILE__, __FUNCTION__, __LINE__, "The bot will say: $botsay",1);
