...
INSERT INTO `bots` (`bot_id`, `bot_name`, `bot_desc`, `bot_active`, `bot_parent_id`, `format`, `update_aiml_code`, `save_state`, `conversation_lines`, `remember_up_to`, `debugemail`, `debugshow`, `debugmode`, `default_aiml_pattern`) VALUES
(1, 'Program O', 'The default Program O chatbot...', 1, 0, 'html', 1, 'session', 7, 10, 0, 3, 1, 'RANDOM PICKUP LINE'),
(7, 'Jean Paul l\\''Chatbotier', 'The french chatbot', 1, 0, 'html', 1, 'session', 7, 10, 0, 1, 1, 'QUI MOI');
