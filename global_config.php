...
/***************************************
  ...
  ***************************************/
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'ses_c9c87638c359cacc110344e159fec769' . $path_separator);
  ...
  $dbn    = 'programo';    # dev database name/prefix
  $dbu    = 'homestead';       # dev database username
  $dbp    = 'secret';  # dev database password
  ...
  $remember_up_to = 10;
  $debugemail = 'seperreau@gmail.com';
  ...
  // Set Misc Data
  //------------------------------------------------------------------------
  $botmaster_name = 'Elizabeth Perreau';
  $charset = 'UTF-8';
